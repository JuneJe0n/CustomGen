...
try:
    ...
    FACE_DET_ROOT = "/data2/jeesoo/js/CustomGen"

# --- Model Configuration ---
BASE_MODEL = "stabilityai/stable-diffusion-xl-base-1.0"

# InstantID paths
INSTANTID_IP_ADAPTER = "/data2/jeesoo/js/CustomGen/models/InstantID/ip-adapter.bin"
INSTANTID_CONTROLNET_FACEKPS = "/data2/jeesoo/js/CustomGen/models/InstantID/ControlNetModel"
INSTANTID_CONTROLNET_DEPTH = "/data2/jeesoo/js/CustomGen/models/controlnet-depth-sdxl-1.0-small"

# InstantStyle paths
INSTANTSTYLE_CONTROLNET_CANNY = "/data2/jeesoo/js/CustomGen/models/controlnet-canny-sdxl-1.0"
