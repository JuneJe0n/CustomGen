...
try:
    ...
    FACE_DET_ROOT = "/data2/CustomGen/CustomGen"

# --- Model Configuration ---
BASE_MODEL = "stabilityai/stable-diffusion-xl-base-1.0"

# InstantID paths
INSTANTID_IP_ADAPTER = "/data2/CustomGen/CustomGen/models/InstantID/ip-adapter.bin"
INSTANTID_CONTROLNET_FACEKPS = "/data2/CustomGen/CustomGen/models/InstantID/ControlNetModel"
INSTANTID_CONTROLNET_DEPTH = "/data2/CustomGen/CustomGen/models/controlnet-depth-sdxl-1.0-small"

# InstantStyle paths
INSTANTSTYLE_CONTROLNET_CANNY = "//data2/CustomGen/CustomGen/models/controlnet-canny-sdxl-1.0"
...
def stage1_instantid_generation(face_image_path, pose_image_path, prompt):
    ...
    app = FaceAnalysis(name="antelopev2", root=str(FACE_DET_ROOT), providers=['CPUExecutionProvider'])
...
def main(face_img_path, pose_img_path, style_img_path, output_path):
    ...
    stage1_output_path = output_dir / f"{output_path.stem}_stage1{output_path.suffix}"
    ...
    try:
        ...
        stage1_result.save(stage1_output_path)
