...
from ip_adapter_id.resampler import Resampler
from ip_adapter_id.utils import is_torch2_available

if is_torch2_available():
    from ip_adapter_id.attention_processor import IPAttnProcessor2_0 as IPAttnProcessor, AttnProcessor2_0 as AttnProcessor
else:
    from ip_adapter_id.attention_processor import IPAttnProcessor, AttnProcessor
from ip_adapter_id.attention_processor import region_control
                ...
                if isinstance(self.controlnet, MultiControlNetModel):
                    ...
                    for control_index in range(len(self.controlnet.nets)):
                        ...
                        if control_index == 0:
                            ...
                            controlnet_prompt_embeds = prompt_image_emb # face img emb
                        else:
                            controlnet_prompt_embeds = prompt_embeds # text emb
