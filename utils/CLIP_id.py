...
def resolve_ffhq_anchor(ffhq_root: Path, id5: str, bucket_size: int, recursive_fallback: bool = False) -> Optional[Path]:
    ...
    Priority:
      ...
      3) (Optional) Recursive rglob search
    """
    idx = int(id5)
...
def main():
    ...
    target_folder = "/data2/jiyoon/custom/results/final/metric/CLIP_ID_facedet/generated_face/infer_7"
    out_file = "/data2/jiyoon/custom/results/final/metric/CLIP_ID_facedet/csv/CLIP_ID_infer7.csv"
    ffhq_root_path = "/data2/jiyoon/custom/results/final/metric/CLIP_ID_facedet/ffhq_face"
    bucket_size = 1000
    target_name = ""
    clip_model = "ViT-L-14"
