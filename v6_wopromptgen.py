"""
(ablation) customgen without promtp generator module
"""
...
def main(face_img_path: str, pose_img_path: str, style_img_path: str, output_path: str, gpu_idx: int = 0):
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA driver initialization failed, you might not have a CUDA gpu.")
